    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-12">
      ...
      <div class="mt-4 bg-white overflow-hidden shadow sm:rounded-md text-sm p-6">
        <p class="text-gray-800">
          <span class="text-semibold">A Thousand Channels GbR</span><br />
          <a href="mailto:hello@a-thousand-channels.xyz" class="text-link">hello@a-thousand-channels.xyz</a><br/>
          <a href="tel:+494039198655">+49 40 391 98 655</a><br />
          Gaußstraße 25b, D-22765 Hamburg<br />
