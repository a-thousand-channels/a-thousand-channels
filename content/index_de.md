...
Seit September 2021 entwicklen wir eine Mappingplattform, mit der queere Narrationen leicht zugänglich auf einer Karte visualisiert und veröffentlicht werden können.
...
Mit *A 1000 channels* ist eine Plattform entstanden, die queeren Akteur*innen, Gruppen, Projekten eine Möglichkeit bietet, von diesen Räumen und Ereignissen zu berichten und sie sichtbar zu machen.
</div>
...
Wir arbeiten mit <a href="https://orte-backend.a-thousand-channels.xyz/" target="_blank" class="text-link">ORTE Backend</a>, ein einfaches, unkompliziertes Backend zum Erstellen und Verwalten von POIs (Point of Interests) – oder 'Orten' ;) – und anderen Daten einer Karte. <br>
...
<div class="block-3">
  ...
  #### <a href="mailto:hello@a-thousand-channels.xyz">E-mail</a> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="21" height="21"><path fill="none" d="M0 0h24v24H0z"/><path d="M22 20.007a1 1 0 0 1-.992.993H2.992A.993.993 0 0 1 2 20.007V19h18V7.3l-8 7.2-10-9V4a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v16.007zM4.434 5L12 11.81 19.566 5H4.434zM0 15h8v2H0v-2zm0-5h5v2H0v-2z"/></svg>
   ...
   Schreibt uns eine <a href="mailto:hello@a-thousand-channels.xyz" class="text-link">E-Mail</a>
